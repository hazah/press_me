require 'rack/cache_file'

module Rack

  # The Rack::CacheServer middleware intercepts requests for static files
  ...
  #
  #     use Rack::CacheServer, :urls => ["/media"]
  #
  # Serve all requests beginning with /css or /images from the folder "public"
  # in the current directory (ie public/css/* and public/images/*):
  #
  #     use Rack::CacheServer, :urls => ["/css", "/images"], :root => "public"
  #
  # Serve all requests to / with "index.html" from the folder "public" in the
  # current directory (ie public/index.html):
  #
  #     use Rack::CacheServer, :urls => {"/" => 'index.html'}, :root => 'public'
  #
  # Serve all requests normally from the folder "public" in the current
  # directory but uses index.html as default route for "/"
  #
  #     use Rack::CacheServer, :urls => [""], :root => 'public', :index =>
  #     'index.html'
  #
  # Set custom HTTP Headers for based on rules:
  #
  #     use Rack::CacheServer, :root => 'public',
  #         :header_rules => [
  ...
  class CacheServer
    ...
    def initialize(app, options={})
      ...
      @cache_server = Rack::CacheFile.new(root, @headers)
    end
